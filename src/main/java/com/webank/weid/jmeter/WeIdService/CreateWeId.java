...
public class CreateWeId extends AbstractJavaSamplerClient {
    ...
    public void setupTest(JavaSamplerContext context) {
        getNewLogger().info("--------------------->this is create weid setupTest");
...
//        arguments.addArgument("name", this.name);
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        result.setSampleLabel("create weid");
        result.sampleStart();
        ResponseData<CreateWeIdDataResult> rr = this.weIdService.createWeId();
