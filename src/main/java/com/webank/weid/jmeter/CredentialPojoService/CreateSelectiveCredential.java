...
public class CreateSelectiveCredential extends AbstractJavaSamplerClient {
    ...
    private static volatile ClaimPolicy claimPolicy = new ClaimPolicy();
    static {
    ...
    public static void main(String[] args) {
        ...
        CreateSelectiveCredential test = new CreateSelectiveCredential();
        test.setupTest(arg0);
        test.runTest(arg0);
    ...
    public void setupTest(JavaSamplerContext context) {
        getNewLogger().info("--------------------->this is CreateSelectiveCredential setupTest");
...
//        arguments.addArgument("name", this.name);
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        result.setSampleLabel("CreateSelectiveCredential");
        result.sampleStart();
        ...
        if (rr.getResult() == null) {
            try {
                throw new Exception("CreateSelectiveCredential:" +
                        rr.getErrorCode() + ", " +
                        rr.getErrorMessage());
            } catch (Exception e) {
                e.printStackTrace();
                getNewLogger().error("------------->CreateSelectiveCredential fail:", e);
                result.sampleEnd();
            ...
            getNewLogger().info("----------------->CreateSelectiveCredential"+rr.toString());
            result.sampleEnd();
        }
        return result;
    }
